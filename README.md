# agric solution tech - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **agric solution tech**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@agricsolutiontech.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@agricsolutiontech.cm` | `user123` | |
...
*   **Contact :** contact@agricsolutiontech.cm